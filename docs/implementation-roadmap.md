...
| Candidate promotion + `append_state_delta` | `scripts/promote_candidate.py` (51 lines) | **Partial** — copies prose, writes decision; **does not apply the delta to canon** | Ledgers (`timeline/knowledge/relationship/promises.jsonl`) are never updated |
